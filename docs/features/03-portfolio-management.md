Feature 3 — Gestión de portfolio

Descripción
Permite registrar operaciones de compra y venta de acciones y administrar las posiciones actuales del usuario dentro de su portfolio.

User story
Como inversor, quiero registrar operaciones de compra y venta para mantener actualizado mi portfolio.
